...
from src.voltronsecurity.voltron_snyk import VoltronSnykCodeFinding, snykProject, snykOrg, snykFinding, SnykCodeCollector
...
class TestSnykFinding(unittest.TestCase):
    def setUp(self):
        ...
        self.snykData = {
            ...
            "attributes": {},
            "links": {
                "self": "https://example.com/finding"
            }
        }
    ...
    def setUp(self):
        self.project_data = {
            ...
            "relationships": {
                "target": {
                    "links": {
                        "related": "https://example.com/project"
                    }
                }
            }
        }
...
class TestSnykCodeCollector(unittest.TestCase):
    ...
    def test_scc_gen_session(self):
        ...
        self.assertEqual('token {}'.format(self.test_key), handler.session.headers['Authorization'])
